function [machine_status_pre_pro]=machine_status_pre_process(dat_len,status_static,status_move,status_refule,status_steal,y_variance,y_varmean,refule_add_mean_threshold,refule_add_var_threshold,cal_len_steal,refule_steal_mean_acc_threshold,refule_steal_var_threshold,refule_move_var_threshold)
    ...
    for i=1:dat_len
        ...
        elseif (y_varmean_cal_len_steal(i) <= refule_steal_mean_acc_threshold) && (y_variance(i) >= refule_steal_var_threshold)
