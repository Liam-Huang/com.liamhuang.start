...
for i=2:x_piece_num-1
    if ( (len_array(i) <= threshold_unstable) && (len_array(i-1) >= threshold_stable) && (len_array(i+1) >= threshold_stable) ) || ((len_array(i) <= threshold_unstable) && (len_array(i-1) >= threshold_stable+2))  || ((len_array(i) <= threshold_unstable) && (len_array(i+1) >= threshold_stable+2)) 
